...
const icons = {
  ...
  Vegetables: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M12 12C12 12 7 10 5 6c4 0 7 2 7 6z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12 12C12 12 17 10 19 6c-4 0-7 2-7 6z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12 16C12 16 8 14.5 6 11c3.5 0 6 2 6 5z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Dairy: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
        d="M8 3h8M7 3v2l-2 4v11a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V9l-2-4V3"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Bakery: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
        d="M5 8c0-2.5 2-4 7-4s7 1.5 7 4c0 1-1 2-1 2H6S5 9 5 8z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Meat: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
        d="M14 10c3-3 4-7 2-9s-6-1-9 2C4 6 4 10 7 12l1 1-4 4a1 1 0 0 0 1.4 1.4l4-4 1 1c2 2 6 2 8-1s1-6-2-9"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <nav className="navbar">
      <div className="navbar__inner">
        ...
        >
          <span className="navitem__text" style={{ fontWeight: "bold" }}>
            Shop All
          </span>
        </Link>
        ...
        {categories.map((c) => (
          ...
          >
            <span className="navitem__icon">{icons[c.label]}</span>
        ...
        <Link
          to="/community"
          className={`navitem${active === "Community" ? " navitem--active" : ""}`}
          onClick={() => setActive("Community")}
        >
          <span className="navitem__icon">{icons.Community}</span>
          <span className="navitem__text">Community</span>
        </Link>
